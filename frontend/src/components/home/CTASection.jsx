...
export default function CTASection() {
  ...
  return (
    <section
      ref={ref}
      className="relative px-4 py-28 sm:py-40 overflow-hidden"
    >
      ...
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle at 20% 50%, rgba(255,90,31,0.4) 0%, transparent 50%),
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-white/50 text-lg sm:text-xl max-w-xl mx-auto mb-10 font-light">
            Join thousands who found their perfect home in under 24 hours. Your next chapter starts here.
          </p>
